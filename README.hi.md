...
**121 MCP टूल्स + 8 रिसोर्सेज़ + 2 प्रॉम्प्ट्स · 35 भाषाएँ · 11 AI प्रोवाइडर + OpenRouter के माध्यम से 200+ मॉडल · 10 ग्राफ़ व्यूज़ · शून्य डेटा संग्रह**
...
**Grasp** किसी भी GitHub या GitLab रिपॉज़िटरी — क्लाउड या सेल्फ़-होस्टेड — या लोकल कोडबेस को कुछ ही सेकंड में एक इंटरैक्टिव आर्किटेक्चर मानचित्र में बदल देता है। **121 MCP टूल्स** (साथ ही 8 Resources और 2 गाइडेड Prompts) पूरा एनालिसिस इंजन Claude Code, Cursor, और किसी भी MCP-संगत एजेंट के लिए उपलब्ध कराते हैं।

```
URL पेस्ट करें / फ़ोल्डर खोलें  →  AST एनालिसिस इंजन  →  आर्किटेक्चर मानचित्र + 121 MCP टूल्स
```
...
| **121 MCP टूल्स** | डिपेंडेंसी ग्राफ़, सुरक्षा, **OSV.dev SCA वल्नरेबिलिटी स्कैनिंग**, DORA, ब्रेन स्टोर, Kuzu graph schema v3, communities, ORM tracker, git change impact, आर्किटेक्चर ड्रिफ़्ट डिटेक्शन, टेस्ट कवरेज गैप मैप, ऑर्ग डैशबोर्ड, PR impact action, MCP Resources/Prompts, `grasp setup` एडिटर ऑटो-कॉन्फ़िग |
...
| IDE | इंस्टॉल करें |
|-----|---------|
| **VS Code** | [Install (.vsix)](https://github.com/ashfordeOU/grasp/releases/latest) — `grasp-vscode-3.17.1.vsix` डाउनलोड करें और **Extensions: Install from VSIX…** (`Cmd+Shift+P`) चलाएँ |
...
|---------|----------------|-------|
| **Claude Code** | `claude mcp add grasp -- npx -y grasp-mcp-server` | नेटिव MCP — सभी 121 टूल्स + 8 Resources + 2 Prompts |
...
| Tool | विवरण |
|---|---|
| `grasp_graph_schema` | Kuzu schema v2 introspection — node/edge table परिभाषाएँ (Class, Interface, Method, Constructor + 10 edge types) live row counts के साथ |
...
> **Install:** [GitHub Releases](https://github.com/ashfordeOU/grasp/releases/latest) से `grasp-vscode-3.17.1.vsix` डाउनलोड करें, फिर VS Code में **Extensions: Install from VSIX…** (`Cmd+Shift+P`) चलाएँ।
...
`index.html` और `team-dashboard.html` दोनों footer में वर्तमान संस्करण (`v3.17.1`) प्रदर्शित करते हैं। लोड पर, वे चुपचाप npm registry में नई रिलीज़ की जाँच करते हैं। यदि मिलती है, तो एक dismissible toast प्रकट होता है:
...
**121 MCP टूल्स · 35 भाषाएँ · 11 AI प्रोवाइडर + 200+ मॉडल · शून्य इंस्टॉल · शून्य डेटा संग्रह**
