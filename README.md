...
| IDE | Install |
|-----|---------|
| **VS Code** | [Install (.vsix)](https://github.com/ashfordeOU/grasp/releases/latest) — download `grasp-vscode-3.17.0.vsix` and run **Extensions: Install from VSIX…** (`Cmd+Shift+P`) |
