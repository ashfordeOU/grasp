...
| IDE | Install |
|-----|---------|
| **VS Code** | [Install (.vsix)](https://github.com/ashfordeOU/grasp/releases/latest) — download `grasp-vscode-3.13.2.vsix` and run **Extensions: Install from VSIX…** (`Cmd+Shift+P`) |
...
### 🎯 Connection Confidence Scoring *(v3.13.2)*
...
### ƒ() Function-Level Canvas *(v3.13.2)*
...
### 🔐 PII Detection & Security Subcategories *(v3.13.2)*
...
## Grasp Brain — Persistent Architecture Intelligence *(v3.13.2)*
...
> **Install:** Download `grasp-vscode-3.13.2.vsix` from [GitHub Releases](https://github.com/ashfordeOU/grasp/releases/latest), then in VS Code run **Extensions: Install from VSIX…** (`Cmd+Shift+P`).
