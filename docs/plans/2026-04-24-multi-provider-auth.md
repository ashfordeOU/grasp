...
9. Merge to main: from the parent repo directory (not worktree): `cd GraspRepo && git fetch --no-tags origin main && git merge origin/feature/multi-provider-auth --no-edit && git push origin main`
